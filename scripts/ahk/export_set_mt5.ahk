...
WinWaitActive, ahk_class MetaQuotes::MetaTrader::5.00
IfWinNotActive, ahk_class MetaQuotes::MetaTrader::5.00
{
  WinActivate, ahk_class MetaQuotes::MetaTrader::5.00
}
...
Sleep, 500
ControlGet, IsVisible, Visible, , Button1, ahk_class MetaQuotes::MetaTrader::5.00
if !IsVisible {
  Sleep, 500
  Send, ^r
  Sleep, 500
...
ControlClick, Button1, ahk_class MetaQuotes::MetaTrader::5.00
if ErrorLevel {
